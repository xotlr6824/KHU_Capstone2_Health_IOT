...
class WeekBarChartState extends State<WeekBarChart> {
  ...
  List<BarChartGroupData> showingGroups() => List.generate(7, (i) {
        switch (i) {
          ...
          case 2:
            return makeGroupData(2, 580, isTouched: i == touchedIndex);
          case 3:
            return makeGroupData(3, 750, isTouched: i == touchedIndex);
          case 4:
            return makeGroupData(4, 900, isTouched: i == touchedIndex);
          case 5:
            return makeGroupData(5, 1100, isTouched: i == touchedIndex);
          case 6:
            return makeGroupData(6, 450, isTouched: i == touchedIndex);
          default:
            return throw Error();
        }
      });
